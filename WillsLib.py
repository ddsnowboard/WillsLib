...
def sanitize(string):
	...
	# Finish this function. Make it so that if it finds something from WORD_LIST, it quotes it, unless it's
	# something bad like 'drop', which throws an error. Otherwise, make it just return the string. 
